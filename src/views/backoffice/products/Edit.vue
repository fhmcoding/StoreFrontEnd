...
<script setup>
    ...
    const [name,  brand_id, category_id, is_active, description, price, sale_price, stock_quantity] = form_update_product.useFieldModel(['name','brand_id','category_id','is_active','description','price','sale_price','stock_quantity']);
